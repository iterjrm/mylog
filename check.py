...
chrome_driver = "/home/jrmtzar/mylog/chromedriver"
def iter_login():
    ...
    try:
        ...
        but.click()
        time.sleep(2)
        infbt = browser.find_element_by_xpath("/html/body/div[3]/ng-view/md-content/md-grid-list/md-grid-tile[1]/figure")
        infbt.click()
        time.sleep(2)
